...
console.log(perosns.filter((person) => person.sex == "F"));
// Log all the filtered female ('F') whose name starts with 'C' or 'J' in persons array
console.log(
  persons
    .filter((person) => person.sex == "F")
    .filter((person) => person.startsWith("C") || person.startsWith("J"))
);
...
let sortedArray = [...peopleGrade].sort((a, b) => b - a);
