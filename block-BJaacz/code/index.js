...
*/
function isAdult(peronInfo) {
  return peronInfo.age > 18;
}
...
*/
function isMale(peronInfo) {
  return peronInfo.sex === "M";
}
/*
...
*/
function isFemale(peronInfo) {
  return peronInfo.sex === "F";
}
/*
...
*/
function isGradeA(peronInfo) {
  return peronInfo.grade > 12;
}
/*
...
*/
function isGradeB(peronInfo) {
  return peronInfo.grade > 8 && peronInfo.grade <= 12;
}
/*
